...
int addListener(string listenerName, Listener listeners[], int numSongs, 
                int numListenersStored, int listenersArrSize){
    bool sameNameExists = 0;



    //look for a listener with same name
    ...
    if(numListenersStored >= listenersArrSize){
        ...
        Listener newGuy(listenerName, newArr , listenersArrSize);
        listeners[numListenersStored] = newGuy;
        //cout << "we added him" << endl;
...
int main(){
    ...
    //Listener owen;
    string listenerName = "boti patrol";
    int listenersArrSize = 2;
    Listener listeners[listenersArrSize] = {owen};
    int numSongs = 4;
    int numListenersStored = 1;


    cout << addListener(listenerName, listeners, numSongs, numListenersStored, listenersArrSize) << endl;
    cout << "yeet" << endl;
