...
function
    ask user for input
    just doe whatever for each response
...
int main(){
    //time to make a main driver function
    //cout << "beginning" << endl;
    ...
    while(continuePlease){
        ...
        if((response != 1) && (response  != 2) && (response  != 3) && (response  != 4)){
            ...
            //cool, it was a valid input
            if(response == 1){
                //aight they wanna calc likeness score between 2 strings equal length
                cout << "Enter Sequence 1" << endl;
                cin >> seq1;
                cout << "Enter Sequence 2" << endl;
                cin >> seq2;
                cout << "Likeness Score: " << calcLikenessScore(seq1, seq2) << endl;
                
            }else if(response == 2){
                //aight they wanna calc the best likeness score between 2 strings equal length
                cout << "Enter Sequence 1" << endl;
                cin >> seq1;
                cout << "Enter Sequence 2" << endl;
                cin >> seq2;
                ...
                //they wanna do the one with 4 inputs
                ...
                cin >> seq4;
                findWinner(seq1, seq2, seq3, seq4);
            }
        }
    }
